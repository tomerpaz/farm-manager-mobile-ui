...
import {
    ACTIVITY_FROM, ANALYSIS_TABS, APPROVAL_TABS,
    DOMAIN,
    DOMAIN_HISTORY,
...
import {
    ApprovalTabs, DomainForm, OverviewTabs,
    ResourcesTabs, UtilitiesTabs,
    ActivityForm, AnalysisTabs, DomainHistoryTable, BusinessSettingsTab, Approval
} from "../../../modules";
