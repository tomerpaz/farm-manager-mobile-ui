...
import { REST_TIMING, ACCOUNT, FREQUENCY, FERTILIZER_UNIT, WATER_UNIT } from './WaterSysConsts';
import { WATER_UNITS, FERTILIZER_UNITS } from '../../utils';
...
const TalgilSettings = (props) => {
    const classes = useStyles();


    const { system, newWaterSystemConfig,
        settings, text, saveWaterSystemConfig, deleteWaterSystemConfig,
