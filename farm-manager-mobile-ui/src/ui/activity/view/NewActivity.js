...
const NewActivity = () => {
  ...
  const activity = { type, plan: isPlan, execution: newDate(), activityDef: null, year: user.year, wind, customer: null, fields, resources: [], note: '', invoice: '', editable: true, waybill: '' };
